...
Use this API to add a new lead to a campaign.
...
| Parameter   | Required  | Description   |
|-------------- |---------- |------------------------------------ |
| lead_id   | True  | Unique Identifier for the Lead  |
...
<aside class="success">
  ...
  <p>
    ...
    We call our reps via a masked number. This way the <code>phone_number</code> you share with us is never shared with our reps.
  </p>
</aside>
...
Use this API endpoint to fetch leads.
...
|---------------  |---------- |---------  |------------------------------------------------ |
| lead_id   | False   | -   | ID of the lead that you might want to fetch   |
| min_judged_at   | False   | -   | Minimum time in Epoch to fetch responses since  |
| max_judged_at   | False   | -   | Maximum time in Epoch to fetch responses since  |
...
| Key   | Description   |
|-------------- |-------------------------------- |
| judged_at   | Unique Identifier for the Lead  |
